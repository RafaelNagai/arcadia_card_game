...
export function CardMini({ card, rotation, owner, displayPower, selected, compact, onClick }: CardMiniProps) {
  ...
  return (
    <button type="button" className="card-mini-button" onClick={onClick} title={title}>
      {body}
    </button>
  );
}
